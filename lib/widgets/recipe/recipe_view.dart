  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: recipes != null
              ? recipes.length == 0 ? Center(child: Text("Noch keine Rezepte erstellt", style: Theme.of(context).textTheme.title,)) : ListView.builder(
              ...
              children: <Widget>[
                RichText(
                    text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                              text: "Sind Sie sicher, dass Sie das Rezept "),
                          TextSpan(
                              text: "${recipe.name}",
                              style: TextStyle(fontWeight: FontWeight.bold)),
