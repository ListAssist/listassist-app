...
class GroupCreateShoppingList extends StatefulWidget {

  final String gid;
  GroupCreateShoppingList({this.gid});

  @override
  _GroupCreateShoppingList createState() => _GroupCreateShoppingList();
}

class _GroupCreateShoppingList extends State<GroupCreateShoppingList> {
                  ...
                  child: Container(
                    ...
                    child: ProgressButton(
                      ...
                      onPressed: (AnimationController controller) async{
                        ...
                        DocumentReference docRef = await databaseService.createList(widget.gid, _newShoppingList, true);
                        Navigator.pop(context);
                      },
                    ),
                  ),
