                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ProgressButton(
                      ...
                      onPressed: _submitEnabled ? (AnimationController controller) async{
                        controller.forward();
                        _validateRealTime = true;
                        if (_formKey.currentState.validate()) {
                          if (_passwordController.text == _repeatPasswordController.text) {
                            authService.updatePassword(widget.firebaseUser, _passwordController.text)
                              .catchError((_) {
